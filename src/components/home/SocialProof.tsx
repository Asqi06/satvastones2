...
function WhyTrustSection() {
  const trustReasons = [
    ...
    { icon: MessageSquare, title: "24/7 Customer Support — Call, WhatsApp, Email", desc: "Reach us anytime via phone (+91 98765 43210 — 9 AM to 11 PM), WhatsApp, email (curation@satvastones.com — 4-hour response time), or live chat on our website (AI-assisted with human handoff during business hours).", detail: "Response time: < 1 min on chat • < 4 hours on email • < 30 mins on call" },
  ];
